...
export default function PersonalInfo() {
  ...
  return (
    <div className="bg-gradient-to-b from-transparent to-slate-400 flex sm:flex-row flex-col md:gap-5.0 sm:gap-3.0 gap-2.0 justify-start rounded-md items-end md:px-3.0 sm:px-2.0 px-1.0 py-2.5">
